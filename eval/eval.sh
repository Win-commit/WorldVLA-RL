...
CUDA_VISIBLE_DEVICES=1 python /liujinxin/zhy/ICLR2026/eval/libero_eval_unified.py --ckpt "/liujinxin/zhy/ICLR2026/logs/STAGE2_TRAINER_STAGE1EMABalance/checkpoint-7000" --parallel_reward_groups 10 --reward_group_size 5 --task_suite libero_10 --trials 50 &
