...
def get_action(observation, task_description, model, tokenizer, image_processor, image_tokenizer, processor, action_tokenizer, visual_token_pattern="<|visual token {token_id:0>6d}|>"):
    """使用模型获取动作"""
    # 编码图像
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default="/liujinxin/zhy/ICLR2026/logs/STAGE2_TRAINER_STAGE1EMABalance/checkpoint-3500",
                      help="模型检查点路径")
    ...
    # 创建配置
    cfg = EvaluationConfig()
    cfg.pretrained_checkpoint = args.ckpt
