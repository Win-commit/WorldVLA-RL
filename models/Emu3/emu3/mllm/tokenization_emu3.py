...
class Emu3Tokenizer(PreTrainedTokenizer):
    ...
    def __init__(
        ...
        eot_token = "<|extra_197|>",
        # --- Rwd & RTG type token ---
        rwd_beg_token="<|extra_194|>",
        rwd_end_token="<|extra_195|>",
        rtg_beg_token="<|extra_192|>",
        rtg_end_token="<|extra_193|>",
        # --- Rwd & RTG learnable token ---
        rwd_token = "<|extra_191|>",
        rtg_token = "<|extra_190|>",
        # --- state token ---
        state_beg_token = "<|extra_188|>",
        state_end_token = "<|extra_189|>",
        **kwargs,
    ):
        ...
        self.rwd_beg_token = rwd_beg_token
        self.rwd_end_token = rwd_end_token
        self.rtg_beg_token = rtg_beg_token
        self.rtg_end_token = rtg_end_token
        self.rwd_token = rwd_token
        self.rtg_token = rtg_token
        self.state_beg_token = state_beg_token
        self.state_end_token = state_end_token
